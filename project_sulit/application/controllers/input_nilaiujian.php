...
class input_nilaiujian extends CI_Controller
{
    ...
    public function index()
    {
      $data['title'] = 'PERSETUJUAN JUDUL';
        ...
        $this->template->display('Dosen/v_forminputnilai', $tabel_persetujuan + $data + $nama);
}
...
public function ajax_list()
        ...
        foreach ($list as $mahasiswa) {
            ...
            $row[] = "<div class='btn-group'>                      
                      ...
                      <ul class='dropdown-menu pull-right' role='menu'>
                        ...
                        <li><a href='javascript:void(0)' title='Edit' onclick='edit_mahasiswa(" . '"' . $mahasiswa->nim . '"' . ")'>INPUT NILAI</a>
                        </li>
    ...
    public function ajax_add()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            echo json_encode(array("nilai1","nilai2","nilai3" => TRUE));
        } else {
            $errors = array(
                'status'   => false,
