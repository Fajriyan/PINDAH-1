...
class M_list_proposal extends CI_Model
{
    ...
    var $column_order = array('nim', 'nama', 'judul_proposal', 'draf_proposal', 'status_proposal');
    var $column_search = array('nim', 'nama', 'judul_proposal', 'draf_proposal', 'status_proposal');
